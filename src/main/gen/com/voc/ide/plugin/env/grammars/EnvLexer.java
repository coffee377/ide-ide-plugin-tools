 ...
 * from the specification file <tt>EnvLexer.flex</tt>
 */
public class EnvLexer implements FlexLexer {
   ...
   */
  public EnvLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 10: break;
          case 4:
            { yybegin(YYINITIAL); return EnvTypes.COMMENT;
            }
            // fall through
          case 11: break;
          case 5:
            { yybegin(WAITING_VALUE); return EnvTypes.SEPARATOR;
            }
            // fall through
          case 12: break;
          case 6:
